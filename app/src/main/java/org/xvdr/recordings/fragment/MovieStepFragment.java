...
public class MovieStepFragment extends GuidedStepFragment {
    ...
    public void startGuidedStep(Activity activity, Movie movie) {
        startGuidedStep(activity, movie, android.R.id.content);
    }

    public void startGuidedStep(final Activity activity, final Movie movie, final int resourceId) {
        ...
        AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                getArtwork(activity, movie.getBackgroundImageUrl());
                return null;
            }
